    ...
    <div className='flex flex-col bg-[#679436]'>
        <div className=' bg-[#EBF2FA] rounded-b-2xl'>
            ...
            <div className='flex flex-row mx-20 mt-40'>
                <div className='flex flex-col justify-center items-center w-7/12 border-2'>
                    ...
                    <button className='bg-[#A5BE00] text-[#EBF2FA] rounded-2xl px-6 py-2 my-5'>Get Started</button>
                </div>
        ...
        <div className='flex flex-col my-20 mx-20'>
            <div className='w-1/2'>
                <img src="navbar/landing/image1.png" className='scale-[0.70] flex justify-start' alt="" />
            </div>
            <div className='flex flex-row'>
                <div className='flex flex-col justify-start'>
                    ...
                    <button className='bg-[#A5BE00] text-[#EBF2FA] rounded-2xl px-6 py-2 my-5 w-1/3'>View More</button>
                </div>
            ...
            <div className='mt-10 bg-[#A5BE00] rounded-2xl'>
                <div className='flex flex-row my-10'>
                    ...
                    <div className='flex flex-col justify-start'>
                        <h1 className='font-montserrat font-extrabold text-[44px] text-[#EBF2FA]'>Discuss What's<br/> Happening on Community</h1>
                        ...
                        <button className='bg-[#679436] text-[#EBF2FA] rounded-2xl px-6 py-2 my-5 w-1/5'>View More</button>                    
                    </div>
                </div>
            </div>
            <div className='flex flex-row my-10'>
                <div className='flex flex-col w-1/2'>
                    ...
                    <button className='bg-[#A5BE00]  text-[#EBF2FA] rounded-2xl px-6 py-2 my-5 w-1/5'>View More</button>                    
                </div>
        ...
        <div className='bg-red-400'>
            <div className='flex flex-row mx-20 my-10 justify-between'>
                ...
                <h1 className='font-source-sans font-regular text-[#FFFFFF] text-[24px] my-5'>We're here to help! Reach out to us anytime through our contact</h1> 
                </div>
                <div>
                    <button className='bg-[#A5BE00] text-[#EBF2FA] rounded-2xl px-6 py-2 my-5'>Contact Us</button>
                </div>
                </div>
        </div>
    </div>

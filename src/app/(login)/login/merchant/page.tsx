        ...
        <FormLoginMerchant session={session} />
          <div className="flex flex-row min-h-screen">
            <div className="flex flex-col justify-center p-8 w-1/2 rounded-lg mx-4 jus">
              ...
              <div className="mb-4">
                <label className="block text-green-600 mb-2">Business Name</label>
                <input type="text" className="border-2 p-2 rounded-2xl w-full" />
              </div>

              <div className="mb-4">
                <label className="block text-green-600 mb-2">Business Address</label>
                <input type="text" className="border-2 p-2 rounded-2xl w-full" />
              </div>
              ...
              <div className="mb-4">
                <label className="block text-green-600 mb-2">Contact Details</label>
                <input type="text" className="border-2 p-2 rounded-2xl w-full" />
              </div>
